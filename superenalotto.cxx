...
if(num==6)
    ...
    if (vinto==6) cout<<"VITTORIA!!!";
        else cout<<"\nCi dispiace, i suoi numeri non sono vincenti"<<endl;
        cout<<vinto<<endl;
}